...
```bash
cd /home/user/dev/projectman && python -m pytest tests/test_settings.py -v 2>&1 | head -30
```
...
```bash
cd /home/user/dev/projectman && python -m pytest tests/test_settings.py -v
```
...
```bash
cd /home/user/dev/projectman && python -m pytest tests/test_model_settings.py -v 2>&1 | head -30
```
...
```bash
cd /home/user/dev/projectman && python -m pytest tests/test_model_settings.py -v
```
...
```bash
cd /home/user/dev/projectman && python -c "from model import ProjectStore, ProjectsWatcher; print('OK')"
```
...
```bash
cd /home/user/dev/projectman && python -c "from terminal import TerminalView; print('OK')"
```
...
```bash
cd /home/user/dev/projectman && python -c "from sidebar import Sidebar, ResourceBar; print('OK')"
```
...
```bash
cd /home/user/dev/projectman && python -c "from main import ProjectManApp; print('OK')"
```
...
```bash
cd /home/user/dev/projectman && python -c "from settings_window import SettingsWindow; print('OK')"
```
...
```bash
cd /home/user/dev/projectman && ./projectman
```
