...
```bash
cd /home/user/dev/projectman && python -m pytest tests/test_model_project_management.py -v 2>&1 | head -20
```
...
```bash
cd /home/user/dev/projectman && python -m pytest tests/test_model_project_management.py -v
```
...
```bash
cd /home/user/dev/projectman && python -m pytest tests/ -v
```
...
```bash
cd /home/user/dev/projectman && python -c "from sidebar import Sidebar, NewSessionRow; print('OK')"
```
...
```bash
cd /home/user/dev/projectman && python -c "from sidebar import Sidebar, NewProjectEntryRow; print('OK')"
```
...
```bash
cd /home/user/dev/projectman && python -c "from sidebar import Sidebar, ProjectRow; print('OK')"
```
...
```bash
cd /home/user/dev/projectman && python -c "from window import AppWindow; print('OK')"
```
